...
public record UpdateClockPayload(int x, int y, int z, int timer, boolean hasBell, boolean showsTime) implements CustomPacketPayload {
    ...
    public static final StreamCodec<FriendlyByteBuf, UpdateClockPayload> PACKET_CODEC = StreamCodec.composite(
            ByteBufCodecs.VAR_INT, UpdateClockPayload::x,
            ByteBufCodecs.VAR_INT, UpdateClockPayload::y,
            ByteBufCodecs.VAR_INT, UpdateClockPayload::z,
            ByteBufCodecs.VAR_INT, UpdateClockPayload::timer,
            ByteBufCodecs.BOOL, UpdateClockPayload::hasBell,
